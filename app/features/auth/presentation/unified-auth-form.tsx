        ...
        {process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID ? (
          <button
            ...
            onClick={() => {
              ...
              // This requires:
              // 1. NEXT_PUBLIC_GOOGLE_CLIENT_ID environment variable
              // 2. Backend endpoint to handle Google OAuth callback
              // 3. Google Sign-In SDK integration
              setServerError("Google Sign-In: Not yet implemented. Please contact Trada if GOOGLE_CLIENT_ID is available.");
            }}
            className="w-full py-2.5 rounded-xl font-medium text-sm text-white bg-white/5 hover:bg-white/10 border border-white/20 hover:border-white/30 transition-all flex items-center justify-center gap-2"
          >
